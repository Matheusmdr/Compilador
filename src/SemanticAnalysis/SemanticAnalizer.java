...
System.out.println(e.getMessage()); //Mensagem de erro léxico (em ingles) mostrando linha e coluna
  ...
  void declaracoesParaSemantica() throws ParseException {String tipo = listaDeclaracoes.get(0);
        String valor = "0";
        ...
        for(String identificador : listaDeclaracoes){
            ...
            table.insertTableRow(new SemanticTableObject(identificador, "IDENTIFICADOR", "var", tipo, valor, false, -1));
        }
